...
class TestUserInterface(unittest.TestCase): 
    ...
    def test_can_get_menu_choice_to_display_rules(self): 
        ...
        self.assertEqual(menu_choice, 4)
    ...
    def test_can_display_menu_prompt(self): 
        menu_prompt = self.user_interface.display_menu_prompt()
        self.assertEqual(menu_prompt, ("Tic Tac Toe's MENU"))

    def test_can_get_user_name(self): 
        user_name = self.user_interface.get_players_name()
        self.assertEqual(user_name, "Michelle")
